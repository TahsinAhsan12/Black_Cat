...
Future<Album> fetchAlbum() async {
  final response =
  await http.get('https://jsonplaceholder.typicode.com/albums/1' as Uri);
...
Future<Album> deleteAlbum(String id) async {
  final http.Response response = await http.delete(
    'https://jsonplaceholder.typicode.com/albums/$id' as Uri,
                    ...
                    children: <Widget>[
                      ...
                      RaisedButton(
                        ...
                        onPressed: () {
                          setState(() {
                            _futureAlbum =
                                deleteAlbum(snapshot.data!.id.toString());//Null error
                          });
                        },
                      ),
                    ],
